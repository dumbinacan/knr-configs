...
ffplay http://displaywall:display@192.168.1.40/mjpg/video.mjpg?streamprofile=display_wall_mjpg
#ffplay -fflags nobuffer -flags low_delay http://displaywall:display@192.168.1.40/mjpg/video.mjpg?streamprofile=display_wall_mjpg
